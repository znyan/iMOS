...
class Adapter(nn.Module):
    ...
    def __init__(self, planes, stride, dilation):
        super().__init__()
        
        self.conv = nn.Conv2d(planes, planes // 4, kernel_size=3, stride=stride, dilation=dilation, padding=dilation)
        self.bn1 = nn.BatchNorm2d(planes // 4)
        self.relu = nn.ReLU(inplace=True)
        self.convT = nn.ConvTranspose2d(planes // 4, planes, kernel_size=3, stride=1, dilation=dilation, padding=dilation)
        self.bn2 = nn.BatchNorm2d(planes)
        self.gate = nn.Parameter(torch.ones(1) * 0.02)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1):
        ...
        self.stride = stride
        self.adapter = Adapter(planes, stride=1, dilation=dilation)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1):
        ...
        self.adapter = Adapter(planes, stride=stride, dilation=dilation)
