...
from model.losses import LossComputer, dice_loss
...
class XMemTrainer:
    ...
    def do_pass_valid(self, data):
        ...
        dice = []
        for ti in range(1, t):
            dice_loss_ti = dice_loss(out[f'masks_{ti}'], data['cls_gt'][:,ti,0])
            dice.append((1 - dice_loss_ti).cpu())
